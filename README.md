...
<p>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Scikit_learn_logo_small.svg" width="54"/>
</p>
...
|----------|-------------|------------|
| **[PCOS_DETECTION_ML_DL](https://github.com/vaishnavisingla222/PCOS_Detection_ML_DL)** | A ML & DL -based system for the automated detection of PCOS using both medical tabular and ultrasonic imaging data. | `Python` `Scikit - Learn` `XGBoost` `Tensorflow` `Open-CV`|
...
[![Codolio](https://img.shields.io/badge/Codolio-000000?style=for-the-badge&logo=codeforces&logoColor=white)](https://codolio.com/profile/vaishnavisingla222)
